...
public class ExportWord {
	...
	public String exportWord(){
        ...
        */
        ...
        myDoc.addEle(Paragraph
                .with("This document inside the paragraph, coming from '/Users/chris/Pictures/test.jpg': "
                        + Image.from_FULL_LOCAL_PATHL("/Users/chris/Pictures/test.jpg")
                                .getContent()));
        ...
        File fileObj = new File("/Users/chris/Desktop/Java2word_allInOne.doc");
		...
		return "<html><head><title>Export Word</title><body><h1>Word Erfolgrech Exportiert</h1></body></html>";
